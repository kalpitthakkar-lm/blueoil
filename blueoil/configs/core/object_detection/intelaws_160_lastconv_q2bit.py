...
from blueoil.datasets.intel_aws_3cls import IntelAWSFace
...
PRETRAIN_DIR = "/home/kalpitthakkar/blueoil/saved/wf_160_1x1_exp10_alt_v2_20200415021819/checkpoints"
PRETRAIN_FILE = "save.ckpt-500000"
...
# Train data num per epoch is 434
step_per_epoch = int(234 / BATCH_SIZE)
NETWORK.LEARNING_RATE_KWARGS = {
        "values": [5e-4, 1e-4, 5e-4, 5e-5],       # Try different schedules: finetuning
        # "values": [1e-4, 5e-3, 1e-3, 5e-4],
        "boundaries": [step_per_epoch * 2, step_per_epoch * 80, step_per_epoch * 120],
}
